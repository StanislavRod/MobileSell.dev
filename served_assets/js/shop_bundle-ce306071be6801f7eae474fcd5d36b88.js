var _rollbarConfig = {
  accessToken: "440d97d451734a5e86547daa5513d1a8",
  enabled: false,
  payload: {
    environment: document.getElementsByName("js-evnvironment")[0].getAttribute('content')
  }
};
...
(function() {
  ...
  define('shop/rollbar_notification', function() {
    var env, notify, withNotification;
    env = document.getElementsByName("js-evnvironment")[0].getAttribute('content');
    notify = function(msg) {
      if (env === 'development') {
        return;
      }
    ...
    withNotification = function(name, fn) {
      var f, k, only, result;
      if (typeof name === 'object') {
        ...
        for (k in name) {
          f = name[k];
          result[k] = typeof f === 'function' && ((only == null) || __indexOf.call(only, k) >= 0) ? withNotification(k, f) : f;
        }
        return result;
      } else {
        return function() {
    ...
    return InSales.Cart = (function() {
      ...
      Cart.isEmpty = function(callback) {
        ...
        return this.loadCartData(function(order) {
          var order_line, _i, _len, _ref;
          _ref = order.order_lines;
      ...
      Cart.prototype.setCart = function(order) {
        ...
        order_lines = (function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            _results.push(new InSales.OrderLine(order_line));
          }
          return _results;
        })();
  ...
  define('shop/public/insales/product', ['jquery', 'shop/public/utils', 'shop/public/insales'], function($, utils, InSales) {
    ...
    return InSales.Product = (function() {
      function Product(json) {
        var id, option, property, variant, _ref;
      ...
      Product.prototype.addVariant = function(variant) {
        var option_values, value, _results;
        option_values = variant['option_values'];
        _results = [];
        for (value in option_values) {
          _results.push(this.addValue(option_values[value]));
        }
        return _results;
      };
  ...
  define('shop/public/insales/ecommerce', ['jquery', 'shop/public/insales', 'shop/public/utils'], function($, InSales, utils) {
    ...
    InSales.Ecommerce = (function() {
      function Ecommerce() {
        ...
        if (config.common_js_version || !config.new_ya_metrika) {
          return false;
        }
        this.template = {
          ecommerce: {
      ...
      Ecommerce.prototype.addedProduct = function(line, quantity) {
        ...
        return product = {
          ...
          variant: this.getVariantTitle(line)
        };
      };
...
(function() {
  define('shop/quick_checkout', ['jquery', 'i18n', 'shop/public/insales', 'shop/public/utils', 'public/jquery.modal'], function($, i18n, InSales, _arg) {
    var addOrderItem, addToCart, cartIsEmpty, debounce, init, msg, onAfterAdd, reloadCart, setErrors, showDialog, submit, visitSuccessful;
    addOrderItem = _arg.addOrderItem;
    ...
    setErrors = function(errors) {
      var e, errorsDiv, _i, _len, _results;
      errorsDiv = $('#insales-quick-checkout-dialog .m-modal-errors');
      errorsDiv.empty();
      _results = [];
      for (_i = 0, _len = errors.length; _i < _len; _i++) {
        e = errors[_i];
        _results.push(errorsDiv.append($("<div class='m-modal-error error'>" + e + "</div>")));
      }
      return _results;
    };
    msg = function(msg) {
...
(function() {
  define('shop/checkout', ['jquery'], function($) {
    var Checkout, CheckoutView, add_commas, get_numeric, no_delivery, set_message;
    ...
    CheckoutView = {
      ...
      init: function() {
        ...
        if (!$('#order_use_bonus_points').is(':checked')) {
          $('.bonus_points :input').attr('disabled', true);
        }
        $('#order_use_bonus_points').on('click', function() {
          return $('.bonus_points :input').attr('disabled', !$(this).attr('checked'));
        });
        ...
        $(document).on('loaded:insales:payments', (function(_this) {
          return function(e, payments) {
            ...
            payments || (payments = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
        ...
        $(document).on('loaded:insales:deliveries', (function(_this) {
          return function(e, loadedDeliveries) {
            var _ref;
            loadedDeliveries || (loadedDeliveries = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            _this.pickupDeliveries = [];
            _this.shippingDeliveries = [];
            $.each(loadedDeliveries, function(k, v) {
              if (v.customer_pickup) {
                return _this.pickupDeliveries.push(v);
              } else {
                return _this.shippingDeliveries.push(v);
              }
            });
        ...
        $(document).on('updated:insales:checkout:delivery selected:insales:checkout:delivery', (function(_this) {
          return function(e, order) {
            ...
            order || (order = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            _this.drawTotalPrice(order.items_price + (((_ref1 = order.payment) != null ? _ref1.price : void 0) || 0) + (((_ref2 = order.delivery) != null ? _ref2.price : void 0) || 0));
            return _this.drawDeliveryPrice((_ref3 = order.delivery) != null ? _ref3.price : void 0);
          };
        })(this));
        $(document).on('updated:insales:checkout:payment selected:insales:checkout:payment', (function(_this) {
          return function(e, order) {
            ...
            order || (order = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            _this.drawTotalPrice(order.items_price + (((_ref1 = order.payment) != null ? _ref1.price : void 0) || 0) + (((_ref2 = order.delivery) != null ? _ref2.price : void 0) || 0));
            return _this.drawPaymentPrice((_ref3 = order.payment) != null ? _ref3.price : void 0);
          };
        })(this));
        $('#use_max_bonus_points').on('click', function() {
          var availableBonusPoints, maxBonusPoints;
          maxBonusPoints = parseInt($(this).data('maxBonusPoints'));
          availableBonusPoints = parseInt($(this).data('availableBonusPoints'));
          return $('#order_client_bonus_points').val(Math.min(availableBonusPoints, maxBonusPoints));
        });
        ...
        $(document).on('enable:insales:delivery enable:insales:payment', (function(_this) {
          return function(e) {
      ...
      switchClientType: function($current) {
        ...
        $(passiveTab).find('#client_phone').inputmask('remove');
        $('.ru-mask[data-use-mask] #client_phone:enabled').inputmask("ru-phone");
        return $('.all-country-mask[data-use-mask] #client_phone:enabled').inputmask("phone");
      },
      ...
      checkDeliveryAvailability: function() {
        ...
        if ((activeTab === 'tabs-pickup' && this.pickupDeliveries.length === 0) || (activeTab === 'tabs-need-address' && this.shippingDeliveries.length === 0)) {
      ...
      drawTotalPrice: function(totalPrice) {
        if (totalPrice != null) {
          return $('#total_price').html(InSales.formatMoney(totalPrice));
        }
      },
      ...
      drawPaymentPrice: function(paymentPrice) {
        if (paymentPrice) {
          $('#payment_gateway_price').html(InSales.formatMoney(paymentPrice));
    ...
    Checkout = {
      order: {},
      init: function() {
        $(document).on('click', '#create_order, #set_delivery', (function(_this) {
          return function(e) {
            var $form, errors, _ref;
            ...
            if ((_ref = _this.order.delivery) != null ? _ref.prevent_submit : void 0) {
        ...
        $(document).on('updated:insales:recipient', (function(_this) {
          return function(e, recipient) {
            var _ref;
            recipient || (recipient = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            _this.order.recipient = recipient;
            _this.order.shipping_address.name = recipient.name;
            _this.order.shipping_address.surname = recipient.surname;
            _this.order.shipping_address.middlename = recipient.middlename;
            _this.order.shipping_address.phone = recipient.phone;
            if (!_this.order.client.registered) {
              _this.order.client.name = recipient.name;
              _this.order.client.surname = recipient.surname;
              _this.order.client.middlename = recipient.middlename;
              _this.order.client.phone = recipient.phone;
              _this.order.client.email = recipient.email;
            }
        ...
        $(document).on('updated:insales:address', (function(_this) {
          return function(e, address) {
            var _ref;
            address || (address = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
        ...
        $(document).on('inited:insales:deliveries', (function(_this) {
          return function(e, data) {
            var _ref;
            data || (data = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
        ...
        $(document).on('selected:insales:delivery', (function(_this) {
          return function(e, delivery) {
            var _ref;
            delivery || (delivery = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
        ...
        $(document).on('selected:insales:payment', (function(_this) {
          return function(e, payment) {
            var _ref;
            payment || (payment = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
...
(function() {
  define('shop/checkout_address', ['jquery'], function($) {
    var AddressView, CheckoutAddress;
    AddressView = {
      init: function() {
        $(document).on('updated:insales:address', (function(_this) {
          return function(e, address) {
      ...
      init: function() {
        $(document).on('inited:insales:checkout:order', (function(_this) {
          return function(e, order) {
            var _ref;
            order || (order = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            return _this.address || (_this.address = order.shipping_address);
          };
        })(this));
...
(function() {
  define('shop/checkout_recipient', ['jquery'], function($) {
    var CheckoutRecipient, RecipientView;
    RecipientView = {
      init: function() {
...
(function() {
  define('shop/checkout_delivery', ['jquery', 'shop/public/insales'], function($, InSales) {
    var CheckoutDelivery, Delivery, DeliveryView;
    Delivery = (function() {
      function Delivery(id, price, position, isExternal, externalUrl, customerPickup) {
        this.id = parseInt(id);
      ...
      Delivery.prototype.setFieldsValues = function(fieldsValues) {
        return this.fieldsValues = fieldsValues || [];
      };
      ...
      Delivery.prototype.setError = function(error) {
    ...
    DeliveryView = {
      init: function() {
        ...
        $(document).on('error:insales:delivery', (function(_this) {
          return function(e, error) {
            var _ref;
            error || (error = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
        ...
        $(document).on('changed:insales:deliveries', (function(_this) {
          return function(e, deliveries) {
            var _ref;
            deliveries || (deliveries = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
      ...
      drawCustomFields: function(deliveries) {
        var $field, k, v, _ref, _results;
        _ref = this.uniqFieldsValues(deliveries);
        _results = [];
        for (k in _ref) {
          v = _ref[k];
      ...
      drawInputs: function(deliveries) {
        var $delete, $fieldId, $fieldValue, $target, k, selected, v, _ref, _results;
        $target = $('#hidden-data');
        ...
        for (k in _ref) {
          v = _ref[k];
          $fieldId = $('<input id="order_field_id_' + v.field_id + '" type="hidden" name="order[fields_values_attributes][' + v.field_id + '][field_id]"/>').val(v.field_id);
          $target.append($fieldId);
          if (!v.selected) {
            $delete = $('<input id="order_field_value_' + v.field_id + '" type="hidden" name="order[fields_values_attributes][' + v.field_id + '][_destroy]"/>').val('1');
            $target.append($delete);
            continue;
          }
          $fieldValue = $('<input id="order_field_value_' + v.field_id + '" type="hidden" name="order[fields_values_attributes][' + v.field_id + '][value]"/>').val(v.value);
          _results.push($target.append($fieldValue));
        }
        return _results;
      },
      uniqFieldsValues: function(deliveries) {
        var delivery, k, uniqFieldsValues, v, _ref;
        uniqFieldsValues = {};
        for (k in deliveries) {
          delivery = deliveries[k];
          _ref = delivery.fields_values;
          for (k in _ref) {
            v = _ref[k];
            if (!v.field_id) {
              continue;
            ...
            if (uniqFieldsValues[v.field_id] && uniqFieldsValues[v.field_id].selected) {
              continue;
            }
            uniqFieldsValues[v.field_id] = v;
          }
        }
    ...
    CheckoutDelivery = {
      ...
      init: function() {
        ...
        $.each($('[data-delivery-variants]').data('delivery-variants') || [], (function(_this) {
          return function(k, v) {
            var d;
            d = new Delivery(v.id, v.price, v.position, v.is_external, v.external_url, v.customer_pickup);
      ...
      bind: function() {
        ...
        $(document).on('click', '.delivery_variants .radio_button', (function(_this) {
          return function(e, data) {
            var initClick, _ref;
        ...
        $(document).on('disable:insales:delivery', (function(_this) {
          return function(e) {
            ...
            if (delivery.selected && _this.deliveriesInited) {
              return (_ref = _this.firstAvailable()) != null ? _ref.control().click() : void 0;
            }
          };
        })(this));
        $(document).on('loading:insales:deliveries', (function(_this) {
          return function() {
            ...
            for (k in _ref) {
              ...
              v.active = false;
              v.selected = false;
              _results.push(v.preventSubmit = false);
            }
            return _results;
          };
        })(this));
        $(document).on('loaded:insales:deliveries', (function(_this) {
          return function(e, loadedDeliveries) {
            var changed, currentId, delivery, k, v, _ref, _ref1, _ref2, _ref3, _ref4;
            loadedDeliveries || (loadedDeliveries = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            ...
            for (k in loadedDeliveries) {
              ...
              if ((_ref1 = v.errors) != null ? _ref1.price : void 0) {
                delivery.control().triggerCustom('error:insales:delivery', v.errors.price);
              }
            ...
            currentId || (currentId = (_ref2 = _this.firstAvailable()) != null ? _ref2.id : void 0);
            ...
            if (_this.current() && (!_this.current().available || !_this.current().active)) {
              changed = _this.setCurrent((_ref3 = _this.firstAvailable()) != null ? _ref3.id : void 0);
            }
            _ref4 = _this.deliveries;
            for (k in _ref4) {
              v = _ref4[k];
              if (!v.available) {
        ...
        return $(document).on('switched_type:insales:deliveries', (function(_this) {
          return function(e, currentTab) {
            var _ref, _ref1;
            _this.currentTab = currentTab || ((_ref = e.originalEvent) != null ? _ref.detail : void 0);
            if (_this.currentTab && _this.deliveriesInited) {
              return (_ref1 = _this.firstAvailable()) != null ? _ref1.control().trigger('click') : void 0;
            }
          };
        })(this));
      },
      serialzedDeliveries: function() {
        var k, serialzedDeliveries, v, _ref;
        serialzedDeliveries = {};
      ...
      serializeDelivery: function(delivery) {
        return {
          ...
          fields_values: delivery.fieldsValues,
      ...
      updateDelivery: function(delivery, data) {
        ...
        if (data.external_data !== void 0) {
          return delivery.setExternalData(data.external_data);
        }
      },
      ...
      firstAvailable: function() {
        ...
        for (k in _ref) {
          ...
          if (this.currentTab === '#tabs-pickup' && !v.customerPickup) {
            continue;
          }
          if (this.currentTab === '#tabs-need-address' && v.customerPickup) {
            continue;
          }
    ...
    CheckoutDelivery = {
      ...
      init: function() {
        $(document).on('updated:insales:checkout:delivery selected:insales:checkout:delivery', (function(_this) {
          return function(e, order) {
            var _ref;
            return _this.order || (_this.order = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
          };
        })(this));
        $(document).on('updated:insales:checkout:payment selected:insales:checkout:payment', (function(_this) {
          return function(e, order) {
      ...
      find: function(id) {
        var _base;
        (_base = this.deliveries)[id] || (_base[id] = new Delivery(id));
        return this.deliveries[id];
      },
      set_total_and_delivery_price: function(price) {
        var _ref;
        if ((_ref = this.order.delivery) != null) {
          _ref.price = price ? parseFloat(price) : 0.0;
        }
        return $(document).trigger('updated:insales:checkout:delivery', this.order);
      }
    };
    $(function() {
      return CheckoutDelivery.init();
...
(function() {
  define('shop/checkout_payment_gateway', ['jquery'], function($) {
    var CheckoutPaymentGateway, CheckoutPaymentView, Payment;
    Payment = (function() {
      function Payment(id, price, position) {
        this.id = id;
        this.price = 0.0;
        this.selected = false;
        this.active = false;
    ...
    CheckoutPaymentView = {
      ...
      draw: function($target, payment) {
        var $price;
        $price = $($target.attr('rel'));
        $price.attr('data-price', payment.price).html((payment.price > 0 ? '+' : '-') + ' ' + InSales.formatMoney(Math.abs(payment.price)));
    ...
    CheckoutPaymentGateway = {
      ...
      init: function() {
        $.each($('[data-payment-gateways]').data('payment-gateways') || [], (function(_this) {
          return function(k, v) {
            var p;
            p = new Payment(v.id, v.price, v.position);
        ...
        $(document).on('updated:insales:checkout:delivery selected:insales:checkout:delivery', (function(_this) {
          return function(e, order) {
            var full_price, k, payment, _ref, _ref1, _results;
            order || (order = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
            if (!order.delivery.selected) {
              return true;
            }
            full_price = order.items_price + order.delivery.price;
            _ref1 = _this.payments;
            _results = [];
            for (k in _ref1) {
              payment = _ref1[k];
              _results.push(payment.control().triggerCustom('update:insales:payment', {
        ...
        $(document).on('loading:insales:payments', (function(_this) {
          return function() {
            ...
            for (k in _ref) {
              ...
              v.available = false;
              v.active = false;
              _results.push(v.selected = false);
            }
            return _results;
          };
        })(this));
        return $(document).on('loaded:insales:payments', (function(_this) {
          return function(e, loadedPayments) {
            var changed, currentId, firstElement, k, payment, v, _ref, _ref1, _ref2;
            loadedPayments || (loadedPayments = (_ref = e.originalEvent) != null ? _ref.detail : void 0);
      ...
      serialzedPayments: function() {
        var k, serialzedPayments, v, _ref;
        serialzedPayments = {};
        _ref = this.payments;
        for (k in _ref) {
          v = _ref[k];
  ...
  define('shop/external_delivery', ['jquery'], function($) {
    ...
    ExternalDelivery = {
      ...
      calc: function($target, data) {
        var _base, _name;
        if ((_base = this.queries)[_name = $target.data('deliveryId')] == null) {
          _base[_name] = $.debounce(1000, false, this.load);
        }
      ...
      load: function($target, data) {
        var cacheKey, externalParams, id, _base;
        id = data.delivery.id;
        externalParams = {
    ...
    InSalesPickPoint = PickPoint = (function() {
      ...
      PickPoint.bind = function() {
        ...
        return $(document).on('inited:insales:checkout:deliveries', (function(_this) {
          return function(e, data) {
            var delivery, deliveryId, fv, pp, _ref, _results;
            data || (data = e.originalEvent.detail);
            _ref = _this.instances;
            _results = [];
            for (deliveryId in _ref) {
              pp = _ref[deliveryId];
      ...
      PickPoint.prototype.openModal = function() {
        var city, _ref;
        this.ensureSelected();
        city = (_ref = this.cities[this.currentCity]) != null ? _ref : 'moscow';
      ...
      PickPoint.prototype.calculate = function(fields) {
        ...
        data = {
          _method: 'put',
          order: {
            delivery_variant_id: (_ref = fields.delivery_variant_id) != null ? _ref : this.id
          },
          cart: {
        ...
        return $.post('/cart_items.json', data, (function(_this) {
          return function(response) {
            var ppInfo, _ref1;
            ppInfo = (_ref1 = $.grep(response.order.fields_values_attributes, function(x) {
              return x.field_id === _this.fieldId;
            })[0]) != null ? _ref1.human_value : void 0;
            if (ppInfo) {
...
(function() {
  define('shop/onepage_checkout', ['jquery', 'shop/checkout'], function($, checkout_common) {
    ...
    get_deliveries = function() {
      ...
      return $.ajax({
        url: "/delivery/for_order.json?v2=" + ($('[data-checkout2]').length > 0),
        type: 'PUT',
        dataType: 'json',
        ...
        error: function(xhr, status, error_thrown) {
          ...
          if (delivery_errors_counter >= 6) {
            if (window.Rollbar && !delivery_error_reported) {
      ...
      return $.ajax({
        ...
        error: function(xhr, status, error_thrown) {
          ...
          if (payment_errors_counter >= 6) {
            if (window.Rollbar && !payment_error_reported) {
    ...
    $(function() {
      ...
      $(document).on('typeahead:selected typeahead:autocompleted', '[data-onepage-checkout]', window.debounced_deliveries);
...
(function() {
  define('shop/checkout_init', ['jquery', 'jquery.form', 'jquery.ba-throttle-debounce', 'jquery.bgiframe', 'facebox', 'shop/checkout', 'shop/checkout_address', 'shop/checkout_recipient', 'shop/checkout_delivery', 'shop/checkout_delivery_backward_compatibility', 'shop/checkout_payment_gateway', 'shop/external_delivery', 'shop/pick_point', 'shop/onepage_checkout'], function($) {
    return $(function() {
...
(function() {
  define('shop/bank_bills', ['jquery'], function($) {
    return $(function() {
      ...
      call_back = function() {
        return $form.attr('action', $(this).attr('formaction')).submit().attr('action', original_action);
      };
      $('#get_pdf_receipt').click(call_back);
      $('#print_receipt').click(call_back);
      return $('#get_pdf_receipt_kz').click(call_back);
    });
  });
    ...
    checkRedefined = function(base, switchJs, names) {
      ...
      redefined = (function() {
        ...
        for (_i = 0, _len = names.length; _i < _len; _i++) {
          name = names[_i];
          if (window[name] !== base[name] && (switchJs || __indexOf.call(alreadyKnown, name) < 0)) {
            _results.push(name);
          }
        }
        return _results;
...
(function() {
  ...
  define('shop/export_api', ['jquery', 'shop/check_redefined'], function($, _arg) {
    var checkRedefinedOnLoad, exportApi, exportItems, exportJQuery, guesExportAs, prepareExport, setIn;
    checkRedefinedOnLoad = _arg.checkRedefinedOnLoad;
    ...
    exportApi = function() {
      var InSales, checkout, checkoutDelivery, designBar, onepageCheckout, pickPoint, utils;
      ...
      if (requirejs._defined['shop/design_bar']) {
        designBar = require('shop/design_bar');
        exportItems(designBar, 'const');
      }
      checkout = require('shop/checkout');
      exportItems({
...
(function() {
  define('shop/address_autocomplete', ['jquery'], function($) {
    ...
    $.fn.extend({
      addressAutocomplete: function(action) {
        return this.each(function() {
          var plugin;
    ...
    AddressAutocomplete = (function() {
      ...
      AddressAutocomplete.prototype.bind = function() {
        ...
        return this.localityElement().on('paste.address-autocomplete cut.address-autocomplete', (function(_this) {
          return function(e) {
            return _this.setAddressData();
          };
        })(this));
      ...
      AddressAutocomplete.prototype.reinitState = function() {
        var stateSource, _ref, _ref1;
        if (this.stateElement().filter(':visible').length === 0) {
          return;
        }
        if ((_ref = this.stateEngine) != null) {
          _ref.clear();
        }
        if ((_ref1 = this.stateEngine) != null) {
          _ref1.clearPrefetchCache();
        }
        this.stateElement().typeahead('destroy');
        if (this.country() && $.inArray(this.country(), ['RU', 'KZ', 'UA']) === -1) {
          return;
        }
        ...
        stateSource = (function(_this) {
          return function(q, sync) {
            var v, values, _i, _len, _ref2;
            if (q === '') {
              values = [];
              _ref2 = _this.stateEngine.index.datums;
      ...
      AddressAutocomplete.prototype.reinitCity = function() {
        var citySource, _ref, _ref1;
        if (this.cityElement().filter(':visible').length === 0) {
          return;
        }
        if ((_ref = this.cityEngine) != null) {
          _ref.clear();
        }
        if ((_ref1 = this.cityEngine) != null) {
          _ref1.clearPrefetchCache();
        }
        this.cityElement().typeahead('destroy');
        if (this.country() && $.inArray(this.country(), ['RU', 'KZ', 'UA']) === -1) {
      ...
      AddressAutocomplete.prototype.reinitLocality = function() {
        var localitySource, _ref, _ref1;
        if (this.localityElement().filter(':visible').length === 0) {
          return;
        }
        if ((_ref = this.localityEngine) != null) {
          _ref.clear();
        }
        if ((_ref1 = this.localityEngine) != null) {
          _ref1.clearPrefetchCache();
        }
  ...
  (function($) {
    ...
    Kladr = (function() {
      ...
      Kladr.prototype.drawStartView = function() {
        var currentValue, inputField, url, v, valueType, _i, _len, _ref;
        ...
        if (this.kladrLocation.code) {
          _ref = ['state', 'area', 'city', 'settlement', 'street'];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            v = _ref[_i];
      ...
      Kladr.prototype.createTypeahead = function($selector, results) {
        var data, dataSets, engine, lastType, resultsByTypes, selector, sourceParams, textType, type, typeaheadSource, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
        resultsByTypes = {};
        ...
        dataSets = [];
        _ref1 = ['city', 'state', 'area', 'settlement', 'street'];
        for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
          ...
          typeaheadSource = (function(engine) {
            return function(q, sync) {
              var v, values, _l, _len3, _ref2;
              if (q === '') {
                values = [];
                _ref2 = engine.index.datums;
