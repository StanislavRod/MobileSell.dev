...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"fd0d8ed08d","applicationID":"40346406","transactionName":"c14IQRMOXV4EQR1DUF9BFRoAAlJdFF1GH0tVQhVcDg9CHQ9WRQ==","queueTime":1,"applicationTime":203,"agent":""}</script>
...
<link href="/served_assets/checkout-69769e705ab952b0c34379965d46141c.css" media="screen" rel="stylesheet" type="text/css" />


<link href='/js/custom_checkout.css' rel='stylesheet'>
...
<img alt='logo' id='logo' src='/js/loaded_logo.png'>
...
<div id="flash_messages"><div class="message"><p class="error">Сочетание логина и пароля не подходит</p></div></div>

<div id='top_info'></div>
<div class='set wide_set'><form accept-charset="UTF-8" action="/client_account/session" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
</div><ul class="is-nav"><li class="is-preview-title is-ellipsis"><div class="is-label-theme-preview"><a href="http://www.insales.ru/collection/themes"><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.panel_title">Panel Title</span></a></div>Шаблон интернет магазина - Gadge Square</li></ul><ul class="domoshop-button is-nav is-nav-right" data-demoshop-auth="https://auth.insales.ru/authorized_domains" id="demo-use-theme" style="display: none"><li class="is-theme-action btn-group dropdown"><a class="is-panel-button" href="/admin2/remote_themes/31071448" rel="external" title="<span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.buy_install_help">Buy Install Help</span>"><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.buy_theme">Buy Theme</span></a><a class="dropdown-toggle is-panel-button" data-toggle="dropdown" href="#" type="button"><span class="caret"></span></a><ul class="is-dropdown-menu dropdown-menu-right" role="menu"><li><a href="/admin2/remote_themes/31071448" rel="external" title="<span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.buy_install_help">Buy Install Help</span>"><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.buy_theme">Buy Theme</span></a></li><li><a href="/admin2/remote_themes/31071448/preview" rel="external" title="<span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.preview_help">Preview Help</span>"><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.preview_theme">Preview Theme</span></a></li></ul></li></ul><ul class="is-nav is-nav-right" data-demoshop-auth="https://auth.insales.ru/authorized_domains" id="demo-create-shop" style="display: none"><li class="is-theme-action"><a class="is-panel-button" href="http://www.insales.ru/page/registration_template?demo_shop_account=demo33063&amp;remote_theme_id=31071448" rel="external"><span><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.create_shop">Create Shop</span></span><small><span class="translation_missing" title="translation missing: ru.shop.order_registration.shared.demoshop_panel.use_current_template">Use Current Template</span></small></a></li></ul><a class="is-toggle-panel" href="#" rel="external"><i class="glyphicon panelicon-toggle"></i></a></div></body>
</html>
